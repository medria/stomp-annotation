...
with st.expander("🧭 How to annotate — step-by-step", expanded=True):
    st.markdown(
        ...
        2. **Read the article carefully** — Read the headline and full article text. You can select and copy text directly from the article.

        3. **Review the annotation guidelines** — Refer to the guidelines whenever you are unsure about the definition, type, or ownership of a common space.

        4. **Answer the questions** — Answer the questions shown in the annotation panel based on the article and the guidelines.

        5. **Add notes if needed** — Use the Notes box to flag uncertainty, ambiguity, or anything you think the research team should review.

        6. **Save and continue** — Click **Save & Next** to save your answers and move to the next article. You can use **Previous** to review an earlier article.

        7. **Download your JSONL backup** — Download your file every 5–10 articles and again after completing your batch. Keep the latest downloaded file.
        """
    )
